...
<div class="new-member-congratulation mt-1 mx-1">
    <?= util::displayFlash('client-login-success', 'success') ?>
</div>
...
switch (user('user_role')) {
    case 'Client': ?>
        ...
        <!-- Client Insurance Profile--> 
        <div class="alert alert-secondary p-3 mt-2 mx-4 d-flex flex-column align-items-center text-center">
            <a class="btn btn-success w-100" href="<?= ROOT . '/admin/client/my-profile/' . user('id') ?>">MY PROFILE</a>
        </div>
        <!-- END  Client Insurance Profile-->
...
<!-- <div class="sidebar-footer p-3 border-top">
    ...
    <a href="<?= ROOT . '/logout' ?>" class="btn btn-sm btn-outline-warning w-100 mt-2"><i class="bi bi-box-arrow-left me-1"></i>Logout/Phuma</a>
</div> -->
